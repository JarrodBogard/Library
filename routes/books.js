...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    res.redirect(`/books/${newBook.id}`) // why does this redirect not need "/books/"
    // res.redirect("books");
  } catch {
...
router.get("/:id", async (req, res) => {
  try {
    // populate() converts the id into a specified object that preloads the associated data onto it
...
router.put("/:id", async (req, res) => {
  ...
  try {
    ...
    await book.save()
    res.redirect(`/books/${book.id}`) // redirect put and delete requests
  } catch {
